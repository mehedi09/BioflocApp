...
public class RegisterActivity extends Activity {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (name.isEmpty() || email.isEmpty() || password.isEmpty()
                        || mobileno.isEmpty() || gender.isEmpty()) {
                    ...
                    reqNewAcc(name, email, password,mobileno,gender);
                }
            }
        });
    ...
    private void reqNewAcc (final String name, final String email,
                            final String password,final  String mobileno,final  String gender) {

       final ProgressDialog progressDialog =new ProgressDialog(RegisterActivity.this);

        progressDialog.setCancelable(false);
        progressDialog.setIndeterminate(false);
        progressDialog.setTitle("Reqistration New Account");
        progressDialog.show();
        String url="http://www.hasanmehedi.com/Biofloc/register.php";
        StringRequest request =new StringRequest(Request.Method.POST,      url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        if(response.equals("Sucessfully Registred"))
                        {
...
//                                .getString("created_at");
                        ...
                        // //( String uid,String name, String email,String mobileno,String gender,String created_at)
                    //    db.addUser(uid,name, email,mobileno , gender,created_at);
